...
if ( ! class_exists( 'WPL_Background_Update_Tester_Plugin' ) ) {
class WPL_Background_Update_Tester_Plugin {
...
new WPL_Background_Update_Tester_Plugin;
