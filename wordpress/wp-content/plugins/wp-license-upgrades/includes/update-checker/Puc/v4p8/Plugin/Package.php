<?php
if ( !class_exists('WPLPuc_v4p8_Plugin_Package', false) ):

	class WPLPuc_v4p8_Plugin_Package extends WPLPuc_v4p8_InstalledPackage {
		/**
		 * @var WPLPuc_v4p8_Plugin_UpdateChecker
		 */
		...
		public function isMuPlugin() {
			...
			if ( $cachedResult === null ) {
				...
				if (($muPluginDir === false) || ($pluginPath === false)) {
					...
					$pluginPath  = WPLPuc_v4p8_Factory::normalizePath($this->pluginAbsolutePath);
				}
