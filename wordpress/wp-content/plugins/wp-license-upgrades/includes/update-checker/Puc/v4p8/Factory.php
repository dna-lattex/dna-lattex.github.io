<?php
if ( !class_exists('WPLPuc_v4p8_Factory', false) ):
	...
	class WPLPuc_v4p8_Factory {
		 ...
		 *
		 * @see WPLPuc_v4p8_UpdateChecker::__construct
		 *
		 ...
		 * @return WPLPuc_v4p8_Plugin_UpdateChecker|WPLPuc_v4p8_Theme_UpdateChecker|WPLPuc_v4p8_Vcs_BaseChecker
		 */
		public static function buildChecker($metadataUrl, $fullPath, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = '') {
