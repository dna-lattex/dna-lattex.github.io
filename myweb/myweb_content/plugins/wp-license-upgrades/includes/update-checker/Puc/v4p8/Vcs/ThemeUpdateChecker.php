...
if ( !class_exists('WPLPuc_v4p8_Vcs_ThemeUpdateChecker', false) ):

	class WPLPuc_v4p8_Vcs_ThemeUpdateChecker extends WPLPuc_v4p8_Theme_UpdateChecker implements WPLPuc_v4p8_Vcs_BaseChecker {
		/**
		...
		/**
		 * @var WPLPuc_v4p8_Vcs_Api Repository API client.
		 */
		protected $api = null;

		/**
		 * WPLPuc_v4p8_Vcs_ThemeUpdateChecker constructor.
		 *
		 * @param WPLPuc_v4p8_Vcs_Api $api
		...
		public function requestUpdate() {
			...
			$update = new WPLPuc_v4p8_Theme_Update();
			...
			$update->version = WPLPuc_v4p8_Utils::findNotEmpty(array(
				$remoteHeader['Version'],
				WPLPuc_v4p8_Utils::get($updateSource, 'version'),
			));

			//The details URL defaults to the Theme URI header or the repository URL.
			$update->details_url = WPLPuc_v4p8_Utils::findNotEmpty(array(
