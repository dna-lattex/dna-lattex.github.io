<?php
if ( !class_exists('WPLPuc_v4p8_Vcs_PluginUpdateChecker') ):

	class WPLPuc_v4p8_Vcs_PluginUpdateChecker extends WPLPuc_v4p8_Plugin_UpdateChecker implements WPLPuc_v4p8_Vcs_BaseChecker {
		/**
		...
		/**
		 * WPLPuc_v4p8_Vcs_PluginUpdateChecker constructor.
		 *
		...
		public function requestInfo($unusedParameter = null) {
			...
			$info = new WPLPuc_v4p8_Plugin_Info();
		 ...
		 * @param WPLPuc_v4p8_Plugin_Info $pluginInfo
		 */
