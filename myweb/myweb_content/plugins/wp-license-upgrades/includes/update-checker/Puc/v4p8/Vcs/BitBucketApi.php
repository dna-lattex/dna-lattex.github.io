<?php
if ( !class_exists('WPLPuc_v4p8_Vcs_BitBucketApi', false) ):

	class WPLPuc_v4p8_Vcs_BitBucketApi extends WPLPuc_v4p8_Vcs_Api {
		/**
		 * @var WPLPuc_v4p8_OAuthSignature
		 */
		private $oauth = null;
		 ...
		 * @return null|WPLPuc_v4p8_Vcs_Reference
		 */
		...
		public function getBranch($branchName) {
			...
			return new WPLPuc_v4p8_Vcs_Reference(array(
				'name' => $branch->name,
		 ...
		 * @return WPLPuc_v4p8_Vcs_Reference|null
		 */
		...
		public function api($url, $version = '2.0') {
			$url = ltrim($url, '/');
			$isSrcResource = WPLPuc_v4p8_Utils::startsWith($url, 'src/');
		...
		public function setAuthentication($credentials) {
			...
			if ( !empty($credentials) && !empty($credentials['consumer_key']) ) {
				$this->oauth = new WPLPuc_v4p8_OAuthSignature(
