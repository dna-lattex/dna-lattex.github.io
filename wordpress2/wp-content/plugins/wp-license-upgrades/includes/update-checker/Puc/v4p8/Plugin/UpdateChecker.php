<?php
if ( !class_exists('WPLPuc_v4p8_Plugin_UpdateChecker', false) ):
	 ...
	 * @access public
	 */
	class WPLPuc_v4p8_Plugin_UpdateChecker extends WPLPuc_v4p8_UpdateChecker {
		...
		/**
		 * @var WPLPuc_v4p8_Plugin_Package
		 */
		protected $package;
		...
		public function __construct($metadataUrl, $pluginFile, $slug = '', $checkPeriod = 12, $optionName = '', $muPluginFile = ''){
			...
			$this->extraUi = new WPLPuc_v4p8_Plugin_Ui($this);
		}
		...
		protected function createScheduler($checkPeriod) {
			$scheduler = new WPLPuc_v4p8_Scheduler($this, $checkPeriod, array('load-plugins.php'));
		 ...
		 * @return WPLPuc_v4p8_Plugin_Info
		 */
		public function requestInfo($queryArgs = array()) {
			list($pluginInfo, $result) = $this->requestMetadata('WPLPuc_v4p8_Plugin_Info', 'request_info', $queryArgs);

			if ( $pluginInfo !== null ) {
				/** @var WPLPuc_v4p8_Plugin_Info $pluginInfo */
		 ...
		 *
		 * @return WPLPuc_v4p8_Update|null An instance of Plugin_Update, or NULL when no updates are available.
		 */
		public function requestUpdate() {
			...
			$update = WPLPuc_v4p8_Plugin_Update::fromPluginInfo($pluginInfo);
		 ...
		 *
		 * @return WPLPuc_v4p8_Plugin_Update|null
		 */
		public function getUpdate() {
			$update = parent::getUpdate();
			if ( isset($update) ) {
				/** @var WPLPuc_v4p8_Plugin_Update $update */
		...
		protected function createDebugBarExtension() {
			return new WPLPuc_v4p8_DebugBar_PluginExtension($this);
		}
		...
		protected function createInstalledPackage() {
			return new WPLPuc_v4p8_Plugin_Package($this->pluginAbsolutePath, $this);
		}

		/**
		 * @return WPLPuc_v4p8_Plugin_Package
		 */
