<?php
if ( !class_exists('WPLPuc_v4p8_Plugin_Update', false) ):
	 ...
	 * @access public
	 */
	class WPLPuc_v4p8_Plugin_Update extends WPLPuc_v4p8_Update {
		public $id = 0;
		public $homepage;
		...
		public static function fromJson($json){
			...
			$pluginInfo = WPLPuc_v4p8_Plugin_Info::fromJson($json);
			if ( $pluginInfo !== null ) {
		 ...
		 *
		 * @param WPLPuc_v4p8_Plugin_Info $info
		 * @return WPLPuc_v4p8_Plugin_Update
		 */
		 ...
		 *
		 * @param StdClass|WPLPuc_v4p8_Plugin_Info|WPLPuc_v4p8_Plugin_Update $object The source object.
		 * @return WPLPuc_v4p8_Plugin_Update The new copy.
		 */
