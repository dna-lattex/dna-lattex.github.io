<?php
if ( !class_exists('WPLPuc_v4p8_Scheduler', false) ):

	/**
	 * The scheduler decides when and how often to check for updates.
	 * It calls @see WPLPuc_v4p8_UpdateChecker::checkForUpdates() to perform the actual checks.
	 */
	class WPLPuc_v4p8_Scheduler {
		 ...
		 *
		 * @param WPLPuc_v4p8_UpdateChecker $updateChecker
		...
		public function upgraderProcessComplete(
			...
			if ( is_a($this->updateChecker, 'WPLPuc_v4p8_Theme_UpdateChecker') ) {
			...
			if ( is_a($this->updateChecker, 'WPLPuc_v4p8_Plugin_UpdateChecker') ) {
