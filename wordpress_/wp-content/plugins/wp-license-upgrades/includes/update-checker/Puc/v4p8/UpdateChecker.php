...
if ( !class_exists('WPLPuc_v4p8_UpdateChecker', false) ):

	abstract class WPLPuc_v4p8_UpdateChecker {
		...
		/**
		 * @var WPLPuc_v4p8_InstalledPackage
		 */
		protected $package;

		/**
		 * @var WPLPuc_v4p8_Scheduler
		 */
		public $scheduler;

		/**
		 * @var WPLPuc_v4p8_UpgraderStatus
		 */
		protected $upgraderStatus;

		/**
		 * @var WPLPuc_v4p8_StateStore
		 */
		...
		public function __construct($metadataUrl, $directoryName, $slug = null, $checkPeriod = 12, $optionName = '') {
			...
			$this->upgraderStatus = new WPLPuc_v4p8_UpgraderStatus();
			$this->updateState = new WPLPuc_v4p8_StateStore($this->optionName);
		 ...
		 *
		 * @return WPLPuc_v4p8_InstalledPackage
		 */
		 ...
		 *
		 * @return WPLPuc_v4p8_Update|null
		 */
		 ...
		 *
		 * @return WPLPuc_v4p8_Update An instance of Update, or NULL when no updates are available.
		 */
		 ...
		 *
		 * @param WPLPuc_v4p8_Metadata|null $update
		 */
		protected function fixSupportedWordpressVersion(WPLPuc_v4p8_Metadata $update = null) {
...
//				trigger_error($message, $errorType);
		 ...
		 * @return array [WPLPuc_v4p8_Metadata|null, array|WP_Error] A metadata instance and the value returned by wp_remote_get().
		 */
		...
		protected function createDebugBarExtension() {
			return new WPLPuc_v4p8_DebugBar_Extension($this);
		}

		/**
		 * Display additional configuration details in the Debug Bar panel.
		 *
		 * @param WPLPuc_v4p8_DebugBar_Panel $panel
		 */
