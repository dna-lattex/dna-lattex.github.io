...
if ( !class_exists('WPLPuc_v4p8_Theme_UpdateChecker', false) ):

	class WPLPuc_v4p8_Theme_UpdateChecker extends WPLPuc_v4p8_UpdateChecker {
		 ...
		 *
		 * @return WPLPuc_v4p8_Update|null An instance of Update, or NULL when no updates are available.
		 */
		public function requestUpdate() {
			list($themeUpdate, $result) = $this->requestMetadata('WPLPuc_v4p8_Theme_Update', 'request_update');

			if ( $themeUpdate !== null ) {
				/** @var WPLPuc_v4p8_Theme_Update $themeUpdate */
		...
		protected function createScheduler($checkPeriod) {
			return new WPLPuc_v4p8_Scheduler($this, $checkPeriod, array('load-themes.php'));
		}
		...
		protected function createDebugBarExtension() {
			return new WPLPuc_v4p8_DebugBar_Extension($this, 'WPLPuc_v4p8_DebugBar_ThemePanel');
		}
		...
		protected function createInstalledPackage() {
			return new WPLPuc_v4p8_Theme_Package($this->stylesheet, $this);
		}
	}
