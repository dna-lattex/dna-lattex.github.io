...
if ( !class_exists('WPLPuc_v4p8_Vcs_GitLabApi', false) ):

	class WPLPuc_v4p8_Vcs_GitLabApi extends WPLPuc_v4p8_Vcs_Api {
		/**
		...
		public function getBranch($branchName) {
			...
			$reference = new WPLPuc_v4p8_Vcs_Reference(array(
				'name'        => $branch->name,
