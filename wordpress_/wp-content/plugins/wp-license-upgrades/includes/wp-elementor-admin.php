...
class Admin {
			...
			<form class="elementor-license-box" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<?php endif; ?>
					...
					<p class="e-row-stretch">
						...
						<input type="submit" class="button" value="<?php esc_attr_e( 'Disconnect', 'elementor-pro' ); ?>" disabled /><!-- //ED -->
					</p>
				<?php endif; ?>
			</form>
		</div>
	...
	public function filter_library_get_templates_args( $body_args ) {
		...
		if ( ! empty( $license_key ) ) {
			...
			$body_args['url'] = get_site_transient('wpl_meta')['site_url'];//ED
		}
		...
		<div class="wrap elementor-admin-page-license">
			...
			<form class="elementor-license-box" method="post" action="<?php echo esc_url( admin_url( 'admin-post.php' ) ); ?>">
				...
				<?php else :
					...
					<input type="submit" class="button" value="<?php esc_attr_e( 'Deactivate', 'elementor-pro' ); ?>" disabled /> <!-- //ED -->
